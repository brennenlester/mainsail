  ...
  "hermit-cottage": [
    {
      ...
      introLines: [
        ...
        "The Sovereigns rule the deep places. Tide on the water, Stone on the land. Treat them as peers, not prey.",
        "When both have walked with you, the Moon Shrine can braid them into Horizon.",
      ],
      idleLines: [
        "Tide Sovereign rides the open sail around this isle. Win its respect — spar or bond — and come back to me.",
        "Stone Sovereign keeps the cairn due south. Sail south, not east, to the gray rock ringed with standing stones.",
        "Two peers, one altar. Horizon is born at the Moon Shrine, not on this shore.",
      ],
